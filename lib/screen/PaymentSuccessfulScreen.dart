...
class PaymentSuccessScreen extends StatelessWidget {
  ...
  final int shopprice;
   ...
   const PaymentSuccessScreen({super.key, required this.transactionId, required this.date, required this.totalWithFee, required this.status, required this.quantity, required this.itemDescription, required this.shopprice,});
                    ...
                    child: TextButton(
                      onPressed: () {
                        Navigator.of(context).pushAndRemoveUntil(
                          MaterialPageRoute(builder: (context) => const consumerNavigationScreen()),
